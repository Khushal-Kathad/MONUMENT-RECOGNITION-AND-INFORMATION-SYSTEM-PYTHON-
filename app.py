...
#         # Load your model and label_map
#         loaded_model = tf.keras.models.load_model("D://Advance Python Project//website//updated_model.h5")
#         # print(loaded_model.summary())
#         # label_map = {'Ajanta_Caves': 0, 'Charar-e-Sharief_shrine': 1, 'Chota_Imambara': 2, 'Ellora_Caves': 3,
#         #              'Fatehpur_Sikri': 4, 'Gateway_of_India': 5, 'Hawa_Mahal': 6, 'Humayun%27s_Tomb': 7,
#         #              'India_Gate': 8, 'Khajuraho': 9, 'Konark_Sun_Temple': 10, 'Alai_Darwaza': 11,
#         #              'Alai_Minar': 12, 'Basilica_of_Bom_Jesus': 13, 'Charminar': 14, 'Golden_Temple': 15,
#         #              'Iron_pillar_of_Delhi': 16, 'Jamali_Kamali_Mosque_and_Tomb': 17, 'Lotus_Temple': 18, 'Mysore_Palace': 19,
#         #              'Qutb_Minar': 20, 'Taj_Mahal': 21, 'Brihadisvara_Temple': 22, 'Victoria_Memorial,_Kolkata': 23}
...
#         return render_template('index.html', monument_name=monument_name, monument_coordinates=get_monument_coordinates(predicted_class))
...
def monuments_identification():
    ...
    try:
        ...
        # Loading model 
        loaded_model = tf.keras.models.load_model("updated_model.h5")
